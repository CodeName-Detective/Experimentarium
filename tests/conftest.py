...
def tiny_cfg():
    return {
        ...
        'trainer': {'max_epochs': 1, 'accumulate_grad_batches': 1, 'grad_clip': 1.0, 'log_every_n_steps': 1, 'val_every_n_epochs': 1, 'early_stopping': {'patience': 0}},
        'checkpoint': {'dir': 'outputs/checkpoints/test', 'save_every': 1, 'keep_last_k': 2, 'monitor': 'val/loss', 'mode': 'min', 'resume': None},
